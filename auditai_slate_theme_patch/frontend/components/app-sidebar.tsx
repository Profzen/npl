                  ...
                  <div className="mt-1 space-y-1 flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
                    {recentHistory.map((entry, i) => (
                      <button
                        ...
                        className="flex w-full items-start gap-1.5 rounded-md px-2 py-1.5 text-[11px] leading-4 text-sidebar-foreground/70 bg-sidebar-accent/35 hover:bg-sidebar-accent/55 transition-colors text-left cursor-pointer"
                      >
